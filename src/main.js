...
// CTA button handlers
document
  .querySelectorAll(".btn-cta-primary, .btn-cta-large, .btn-join")
  .forEach((btn) => {
    btn.addEventListener("click", () => {
      alert(
        "🎮 Thanks for your interest! Waitlist signup coming soon.\n\nWe'll notify you when Ludera launches!"
      );
    });
  });
...
const teamMembers = [
  ...
  },
  {
    ...
    bio: "Visual world-builder devoted to expressive, human-centered design. Vivienne has crafted experiences for top creative tools and now brings Ludera’s universe to life.",
